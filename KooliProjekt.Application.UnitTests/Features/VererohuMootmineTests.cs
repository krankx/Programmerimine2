...
namespace KooliProjekt.Application.UnitTests.Features
{
    public class VererohuMootmineTests : TestBase
    {
        ...
        public void List_throws_if_dbcontext_is_null()
        {
            Assert.Throws<ArgumentNullException>(() =>
            {
                new ListVererohuMootmisedQueryHandler(null);
            });
        }
        ...
        {
            var query = new ListVererohuMootmisedQuery { Page = 1, PageSize = 10 };
            var mootmine = new VererohuMootmine
            {
                Kuupaev = new DateTime(2025, 10, 1),
                Kellaaeg = new TimeSpan(9, 0, 0),
        ...
        {
            var query = new ListVererohuMootmisedQuery { Page = page, PageSize = 10 };
            var handler = new ListVererohuMootmisedQueryHandler(DbContext);
        ...
        {
            var query = new ListVererohuMootmisedQuery { Page = 1, PageSize = pageSize };
            var handler = new ListVererohuMootmisedQueryHandler(DbContext);
